...
//subject
//========
$subject="Prestige The City - Google Ads Lead";
...
<tr>
<td width="250" style="border: 1px solid #CCC; border-right:none; padding:10px;">Telephone</td>
<td width="250" style="border: 1px solid #CCC; padding:10px;">'.$mobile.'</td>
</tr>
//   <tr>
//     <td width="250" style="border: 1px solid #CCC; border-right:none; padding:10px;">Message</td>
//     <td width="250" style="border: 1px solid #CCC; padding:10px;">'.$message.'</td>
//   </tr>
</table>';
